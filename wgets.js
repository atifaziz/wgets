...
var ADO, HTTP, Path, ProgramArgumentError, about, alert, args, echo, getFileNameFromURL, i, main, stderr, stdin, stdout, write, writeln, wshargs, _ref,
...
try {
  ...
  args = (function() {
    ...
    _results = [];
    for (i = _i = 0, _ref1 = wshargs.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
      _results.push(wshargs.item(i));
    }
    return _results;
  })();
